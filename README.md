# **MovieZone: A Customized Movie Recommendation Platform**
...
The free tier version of AWS EC2 doesn't have enough space for a collaborate-filtering model of this size. You can try to use your own device as a server to provide the model API. `Your code here`
